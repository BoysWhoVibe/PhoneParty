...
Development approach: Make the website as personal as possible - only implement features specifically requested by the user, avoid using external ideas or implementations found online.
